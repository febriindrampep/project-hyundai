  ...
  return (
    <section className="relative w-full h-screen md:h-[90vh] overflow-hidden bg-gray-900">
      ...
      <div className="absolute inset-0 w-full h-full">
        <Image
          // ⚠️ PERINGATAN: Ganti gambar ini dengan versi LANDSCAPE (min 1920x1080)!
          // Jika tetap pakai gambar portrait, saya sarankan ganti object-cover jadi object-contain
          // dan tambahkan background gradient di bawah ini.
          src="/images/hyundai/414x775 Banner KV Creta.avif" 
          alt="Hyundai Creta - Mobil terbaru"
          fill
          priority
          className="object-cover object-[center_30%] md:object-center" 
          // object-[center_30%] memastikan bagian wajah/mobil tetap terlihat di mobile
          sizes="100vw"
          quality={85}
          placeholder="blur"
        ...
        />
        {/* Overlay lebih gelap agar teks sangat terbaca */}
        <div className="absolute inset-0 bg-black/50" />
      </div>

      {/* Konten Teks - Menggunakan CSS Animasi */}
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6 md:px-12 lg:px-24">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 animate-fade-up animation-delay-400">
          <Link
            href="#cars"
            className="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-full font-semibold transition duration-300 shadow-lg hover:shadow-blue-500/50"
          >
            Lihat Semua Mobil
          </Link>
          <Link
            href="/about"
            className="px-8 py-3 bg-white/20 backdrop-blur-sm hover:bg-white/30 border border-white/30 rounded-full font-semibold transition duration-300"
          >
